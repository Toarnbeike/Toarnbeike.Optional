...
public class OrElseExtensionsTests
{
    ...
    public async Task OrElseAsync_ShouldReturnAlternative_WhenOptionIsNone()
    {
        ...
        result.ShouldBeSome().ShouldBe(2);
    }
