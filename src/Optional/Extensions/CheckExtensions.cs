...
public static class CheckExtensions
{
    ...
    extension<TValue>(Option<TValue> option)
    {
        ...
        public Option<TValue> Check(Func<TValue, bool> predicate)
        {
            ...
            return !option.TryGetValue(out var value) ? Option.None : predicate(value) ? option : Option.None;
        }
        ...
        {
            ArgumentNullException.ThrowIfNull(predicate);
            return !option.TryGetValue(out var value) ? Option.None : await predicate(value).ConfigureAwait(false) ? option : Option.None;
        }
    }
